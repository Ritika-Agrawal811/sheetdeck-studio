...
import type { CategoryStat, ConfigResponse, GlobalStats } from '../types/config';
...
export const categoryStats: Readable<CategoryStat[]> = derived(
  configStore,
  ($store) => $store.data?.categoryStats ?? []
);
